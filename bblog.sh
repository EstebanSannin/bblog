...
# genera la home se non esiste
 home(){ 
         ...
         if [ ! -e ${INDEX} ]; then
                 ...
                 echo "<!-- ;10000000000000000000000000; utf8 meta tag  --><meta http-equiv=\"Content-Type\" CONTENT=\"text/html; charset=UTF-8\">" >> ${INDEX}
		 echo "<!-- ;1000000000000000000000000; fixed content --><div id=\"footer\"><pre><font color=red>  BBLOG (vee mod)</font> version by <font color=yellow><a href=\"http://esteban.homelinux.org\">EstebanSannin</a></font></pre></div>" >> ${INDEX}
                 echo "<!-- ;100000000000000000000000;   fixed content --><div id=\"header\"><pre><h2>$TITLE_SITE<blink>_</blink></h2><table border=\"0\"><tr>" >> ${INDEX}
                 echo "<!-- ;10000000000000000000000;   fixed content --><td class=\"headitem\"><a href=\"$HREF_LINK1\">$NAME_LINK1</a></td>" >> ${INDEX}
                 echo "<!-- ;1000000000000000000000;   fixed content --><td class=\"headitem\"><a href=\"$HREF_LINK2\">$NAME_LINK2</a></td>" >> ${INDEX}
		 echo "<!-- ;100000000000000000000;   fixed content --><td class=\"headitem\"><a href=\"$HREF_LINK3\">$NAME_LINK3</a></td>" >> ${INDEX}
		 echo "<!-- ;10000000000000000000;   fixed content --><td class=\"headitem\"><a href=\"$HREF_LINK4\">$NAME_LINK4</a></td>" >> ${INDEX}
		 echo "<!-- ;1000000000000000000;   fixed content --><td class=\"headitem\"><a href=\"$HREF_LINK5\">$NAME_LINK5</a></td>" >> ${INDEX}
		 echo "<!-- ;100000000000000000;   fixed content --><td class=\"headitem\"><a href=\"$HREF_LINK6\">$NAME_LINK6</a></td>" >> ${INDEX}
		 echo "<!-- ;10000000000000000;   fixed content --><td class=\"headitem\"><a href=\"$HREF_LINK7\">$NAME_LINK7</a></td></tr></table></div>" >> ${INDEX}
	
		 echo "<!-- ;1000000000000000;   fixed content --><div id=\"content\"><pre>" >> ${INDEX}
                 echo "<!-- ;100000000000000;   fixed content --><h3>LIST POST:</h3>" >> ${INDEX}
